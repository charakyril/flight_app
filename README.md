...
ΛΟΙΠΟΝ :) ουσιαστικά έγραψα την html (πήρα το template από μια ιστοσελίδα και άλλαξα τα δεδομένα για να ταιριάζει σε αυτό που θέλουμε και δεν έβαλα σχόλια γτ δεν ήξερα τι να σχολιασω :'( εαν θες κάτι να μου στείλεις ) Νμζ δεν άλλαξα κάτι στον κώδικα python, sql... Έκανα την σύδεση με το δικό μου sql workbench 
...
για να το συνδέσεις με το δικό σου (δεν θυμάμαι εαν το έχεις κάνει) αλλάζεις τα δεδομένα στο host,port,user, το δικό σου password και το όνομα το database 
![alt text](image.png)
κάτι τέτοιο 

Εαν τρέξεις python3 app.py και μετά ανοίξεις το localhost:8080 θα σου ανοίξει την σελίδα (αυτό πρέπει να βλέπεις)
![alt text](image-1.png)  
 απλά εάν βάλεις τιμές και πατήσεις search θα βγάλει error δεν ξέρω γιατι :'( αυτό νομίζω είναι το νέο πρόβλημα...